      ...
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div className="animate__animated animate__fadeInUp animate__delay-3s">
          ...
          <div className="flex items-center sm:gap-4 gap-2">
            <a href="https://drive.google.com/drive/folders/1nLdXL_yND55FipGCB0NtxLqOMDxh4vqp?usp=sharing" className="bg-yellow-500 p-4 rounded-2xl hover:bg-blue-400" target="_blank">
              CV Download <i className="ri-download-2-line ri-md"></i>
            </a>
